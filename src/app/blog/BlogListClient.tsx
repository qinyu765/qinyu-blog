    ...
    <div className="max-w-4xl mx-auto animate-in fade-in slide-in-from-right-8 duration-500">
      ...
      <div
        className={`transition-all duration-300 ease-out ${
          isSearchExpanded
            ? 'max-h-20 mb-10 opacity-100 translate-y-0 overflow-visible'
            : 'max-h-0 mb-0 opacity-0 -translate-y-2 pointer-events-none overflow-hidden'
        }`}
      >
